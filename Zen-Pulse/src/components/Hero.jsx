      ...
      <div className="container mx-auto relative flex flex-col backdrop-blur-[2px] py-3 px-2 h-full ">
        ...
        <div className="absolute bottom-10 md:bottom-4 px-3 flex flex-wrap gap-4  ">
          <div className="flex flex-col items-center justify-center gap-2">
            <span className="text-gray-200 font-bold text-3xl md:text-2xl lg:text-4xl">60+</span>
            <span className="text-gray-200 font-light  text-sm">
              Successful Projects
            </span>
          </div>
          <div className="flex flex-col items-center justify-center gap-2 px-3">
            <span className="text-gray-200 font-bold text-3xl md:text-2xl lg:text-4xl">80+</span>
            <span className="text-gray-200 font-light text-sm">
              Happy Clients
            </span>
          </div>
          <div className="flex flex-col items-center justify-center gap-2 px-3">
            <span className="text-gray-200 font-bold text-3xl md:text-2xl lg:text-4xl">100%</span>
            <span className="text-gray-200 font-light text-sm">
